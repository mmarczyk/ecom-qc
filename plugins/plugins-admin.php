...
function extendProductTab() {
    return new class {
        function getName() {
            return '<li class="tabReviews"><a href="#more" onclick="displayTab( \'tabReviews\' )">Opinie</a></li>';
        }

        function getContent() {
            $content = '<tr class="l'.( ( $i % 2 ) ? 0: 1 ).'"><td><input type="checkbox" name="aFilesDelete[0]" value="1" /></td><td class="name">Tomasz</td><td class="position">Fajna zabawka</td><td class="description">wszystko fajnie</td><td class="place">5</td></tr>';

            return '<div class="tab" id="tabReviews"><table id="files-list" cellspacing="1"><thead><tr><th class="delete">'.$lang['Delete'].'</th><th class="name">Autor</th><th class="position">Tytuł</th><th class="description">Opis</th><th class="place">Ocena</th></tr></thead><tbody>'.$content.'</tbody></table></div>';
        }
    };
}
?>